		...
		<div class="container h-100">
			<div class="row justify-content-md-center h-100">
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							<h4 class="card-title">New Lecturer Registration</h4>
							<form method="POST" class="my-login-validation" action="reg.php">
								...
								<div class="form-group">
									...
									<select name="title" class="form-control mt-3">
                                                <option>
                                               Select Title
                                                </option>
								...
								<div class="form-group">
									<label for="name">Area of Spcecialty</label>
									<select name="area" class="form-control mt-3">
                                                <option>
                                               Select your Area
                                                </option>
																								<?php
