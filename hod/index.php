...
<html>
<head>
<title>Meru Timetable Notification System - HOD</title>
...
<div id="wrapper">
            ...
            <ul class="nav navbar-nav navbar-right">
			    ...
			    <li class="dropdown">
	        		...
	        		<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li class="m_2"><a href="../home/index.html"><i class="fa fa-lock"></i> Logout</a></li>
	        		</ul>
	      		</li>
			</ul>
    ...
    <div class="content_bottom">
      <h3>Timetable Schedules</h3>
		...
		<div class="copy">
            <p>Copyright &copy; Meru. All Rights Reserved  </p>
	    </div>
		</div>
       </div>
      <!-- /#page-wrapper -->
